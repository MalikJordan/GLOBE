...
# ----------------------------------------------------------------------------------------------------
# GLOBE
path = os.getcwd() + '/concentration_bfm56-arbitrary_mesozoo2.npz'
...
# Tracer Indices
path = os.getcwd() + '/tracer_indices_bfm56-arbitrary_mesozoo2.npz'
...
# pyPOM1D-BFM
path = os.getcwd() + '/tests/bfm56/data/bfm56_pom1d-arbitrary_mesozoo2.nc'
